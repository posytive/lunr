...
class MySQLDMLQueryBuilderConditionTest extends MySQLDMLQueryBuilderTest
{
    ...
    {
        $property = $this->builder_reflection->getProperty('group');
        $property->setAccessible(TRUE);

        $method = $this->builder_reflection->getMethod('start_on_group');
        $method->invoke($this->builder);

        $this->assertEquals('join', $property->getValue($this->builder));
    }
    ...
    public function testOpeningGroupWhere()
    {
        ...
        $this->assertEquals('where', $property->getValue($this->builder));
    }
    ...
    public function testOpeningGroupHaving()
    {
        ...
        $this->assertEquals('having', $property->getValue($this->builder));
    }
